		...
		<div class="content-in">
			<div class="column-left">
				<div class="column-left-in">
					<h2>Welcome to Share Your Knowledge...</h2>
				
					<p class="text-content">
					
					    
						This Share Your Knowledge is the most complete web portal for Sharing your knowledge. Users/Students can share their knowledge on any educational topic with                        their Colleagues through these web portal.
					...
					<p class="text-content">
                         It has full specified system where a fresher student can get idea about any system /topic/event through the pass out students throw his post on these web                        portal. 
                    </p>
                    <hr class="noscreen" />
